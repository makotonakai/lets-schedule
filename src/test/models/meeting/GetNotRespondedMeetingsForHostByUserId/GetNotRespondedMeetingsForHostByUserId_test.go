...
func TestGetNotRespondedMeetingsForHostByUserIdFirst(t *testing.T){
	...
	result, err := models.GetNotRespondedMeetingsForHostByUserId(gormDB, userId)
...
func TestGetNotRespondedMeetingsForHostByUserIdNil(t *testing.T){
