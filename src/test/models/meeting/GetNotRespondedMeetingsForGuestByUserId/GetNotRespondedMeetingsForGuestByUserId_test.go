...
import (
	...
	func TestGetNotRespondedMeetingsForGuestByUserIdFirst(t *testing.T){
		...
		result, err := models.GetNotRespondedMeetingsForGuestByUserId(gormDB, userId)
	...
	func TestGetNotRespondedMeetingsForGuestByUserIdNil(t *testing.T){
